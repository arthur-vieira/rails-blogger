class AuthorsController < ApplicationController
  ...
  before_filter :zero_authors_or_authenticated, only: [:new, :create] # this filter will run the method "zero_authors_or_authenticated" before the "new" and "create" actions
